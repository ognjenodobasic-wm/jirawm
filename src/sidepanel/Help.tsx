  ...
  return (
    <div>
      ...
      <Card>
        ...
        <ActionList
          items={[
            <span><strong>✎</strong> top-left — the screenshot has been annotated</span>,
            <span><strong style={{ color: 'var(--chrome-blue)' }}>●</strong> top-right (blue dot) — capture details were edited for this screenshot</span>,
            <span><strong>1 2 3</strong> bottom-left — sequence number (see Settings → Screenshot naming)</span>,
          ]}
        />
        <Text>
      ...
      <Card>
        ...
        <Text>
          Open a thumbnail, then activate Crop before drawing anything. Drag a selection, resize
          with the handles, click Apply. Crop is disabled once you have drawn annotations — this
          prevents your work from being cut away. Undo after a crop restores the full original.
        </Text>
      </Card>
