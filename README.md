...
|---|---|---|
| Crop | C | Select a region and apply. Crop before annotating — disabled once you've drawn anything |
| Select | V | Move or delete existing annotations |
| Arrow | A | Draw an arrow pointing at something |
| Rectangle | R | Outline rectangle to highlight a region |
| Fill | F | Solid filled rectangle — handy for covering sensitive info |
| Marker | M | Numbered circle, auto-incrementing: ①, ②, ③ |
| Text | T | Click to place editable text |
